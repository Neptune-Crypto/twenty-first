...
impl From<ProcessorTableColumn> for usize {
    fn from(c: ProcessorTableColumn) -> Self {
        match c {
            ...
            ProcessorTableColumn::RAMP => todo!(),
            ProcessorTableColumn::RAMV => todo!(),
            ProcessorTableColumn::AUX0 => todo!(),
            ProcessorTableColumn::AUX1 => todo!(),
            ProcessorTableColumn::AUX2 => todo!(),
            ProcessorTableColumn::AUX3 => todo!(),
            ProcessorTableColumn::AUX4 => todo!(),
            ProcessorTableColumn::AUX5 => todo!(),
            ProcessorTableColumn::AUX6 => todo!(),
            ProcessorTableColumn::AUX7 => todo!(),
            ProcessorTableColumn::AUX8 => todo!(),
            ProcessorTableColumn::AUX9 => todo!(),
            ProcessorTableColumn::AUX10 => todo!(),
            ProcessorTableColumn::AUX11 => todo!(),
            ProcessorTableColumn::AUX12 => todo!(),
            ProcessorTableColumn::AUX13 => todo!(),
            ProcessorTableColumn::AUX14 => todo!(),
            ProcessorTableColumn::AUX15 => todo!(),
        }
    }
}
