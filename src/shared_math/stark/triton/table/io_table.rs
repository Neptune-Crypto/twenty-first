...
pub const FULL_WIDTH: usize = 1; // For I/O Tables, there are no extension columns
...
impl IOTable {
    ...
    pub fn extend(
        ...
        assert_eq!(
            ...
            initials.processor_eval_sum,
            "The Evaluation Argument's initial for the I/O Tables must be 0."
        );
        ...
        for row in self.data().iter() {
            ...
            running_sum = running_sum * challenges.processor_eval_row_weight
                + extension_row[IOSymbol as usize];
...
pub struct IOTableEndpoints {
    /// If initial, then 0. Else, the computed terminal.
