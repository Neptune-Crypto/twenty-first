...
mod test_polynomials {
    ...
    fn polynomial_arithmetic_property_based_test() {
        ...
        for i in 0..20 {
            ...
            assert_eq!(mul_a_b.clone() / b.clone(), a);
            assert_eq!(mul_b_a.clone() / a.clone(), b);
            assert_eq!(add_a_b.clone() - b.clone(), a);
            assert_eq!(sub_a_b.clone() + b.clone(), a);
            assert_eq!(add_b_a.clone() - a.clone(), b);
            assert_eq!(sub_b_a.clone() + a.clone(), b);
