...
mod test_mpolynomials {
    ...
    fn print_display_xfield_test() {
        ...
        let expected = [
            "(0000000000000007·x² + 0000000000000006·x + 0000000000000005) + ",
            "(000000000000000D·x² + 000000000000000C·x + 000000000000000B)*x_0^2 + ",
            "(000000000000000A·x² + 0000000000000009·x + 0000000000000008)*x_1 + ",
            "(0000000000000010·x² + 000000000000000F·x + 000000000000000E)*x_0^3*x_1^4",
        ]
        .concat();
        assert_eq!(expected, format!("{}", mpoly));
    }
