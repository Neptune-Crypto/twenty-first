...
pub fn casting() {
    ...
    // Rust does not allow for implicit casting, so this gives a compile-time error
    // let integer2: u8 = decimal;
    ...
    // But there are limits to the conversions, a float
    // cannot be directly cast to a char
