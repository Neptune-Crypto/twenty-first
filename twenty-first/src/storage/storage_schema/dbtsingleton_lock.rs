...
impl<V> Clone for DbtSingletonLock<V> {
    fn clone(&self) -> Self {
        Self {
...
impl<V> DbtSingletonLock<V>
where
    V: Default,
{
    // DbtSingletonLock can not be instantiated directly outside of this crate.
    #[inline]
    pub(crate) fn new(
        key: RustyKey,
        lock_name: String,
...
impl<V> StorageSingleton<V> for DbtSingletonLock<V>
where
...
impl<V> DbTable for DbtSingletonLock<V>
where
