...
where
    V: Clone,
{
    // DbtVecLock cannot be instantiated directly outside of this crate.
    #[inline]
    pub(crate) fn new(
...
impl<T> StorageVecRwLock<T> for DbtVecLock<T> {
...
impl<V> StorageVec<V> for DbtVecLock<V>
where
    V: Clone + Debug,
    V: DeserializeOwned,
{
...
impl<V> DbTable for DbtVecLock<V>
where
    V: Clone,
