...
#
# sage poseidon_generate_parameters_grain.sage 1 0 64 16 8 22 0xffffffff00000001
#                                              | | |  |  | |  |
#               field is prime field (not 2^n) ┘ | |  |  | |  |
#               s-box's power is some α (not -1) ┘ |  |  | |  |
#   number of bits of the prime defining the field ┘  |  | |  |
#                  number of “cells”, i.e, state size ┘  | |  |
#                                  number of full rounds ┘ |  |
#                                 number of partial rounds ┘  |
#                the prime defining the field, in hexadecimal ┘
