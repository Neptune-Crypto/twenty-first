...
impl Poseidon {
    ...
    const MDS_MATRIX_CIRC: [BFieldElement; STATE_SIZE] = [
        BFieldElement::new(0x0),
        BFieldElement::new(0x1),
        BFieldElement::new(0x2),
        BFieldElement::new(0x3),
        BFieldElement::new(0x4),
        BFieldElement::new(0x5),
        BFieldElement::new(0x6),
        BFieldElement::new(0x7),
        BFieldElement::new(0x8),
        BFieldElement::new(0x9),
        BFieldElement::new(0xa),
        BFieldElement::new(0xb),
        BFieldElement::new(0xc),
        BFieldElement::new(0xd),
        BFieldElement::new(0xe),
        BFieldElement::new(0xf),
    ];
