# https://extgit.iaik.tugraz.at/krypto/hadeshash/-/tree/master/code
...
# parameters allowing comparison to Tip5

oxfoi_prime = 0xffffffff00000001
sponge_size = 16
s_box_alpha = 7
security_level = 160
add_security_margin = True

parameters = calc_final_numbers_fixed(oxfoi_prime, sponge_size, s_box_alpha, security_level, add_security_margin)
print(f"prime:           {hex(oxfoi_prime)}")
print(f"sponge size:     {sponge_size}")
print(f"s_box_alpha:     {s_box_alpha}")
print(f"security [bits]: {security_level}")
print(f"with margin:     {add_security_margin}")
print()
print(f"full rounds:     {parameters[0]}")
print(f"part rounds:     {parameters[1]}")
